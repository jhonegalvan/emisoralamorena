(function () {
    ...
    const API_URL = "https://twj.es/metadata/?url=https://stream.zeno.fm/eccwblcjp3wuv";
    ...
    // Usar el elemento de audio ya existente en el HTML
    ...
    function play(audio, newSource = null) {
        ...
        if (playPromise !== undefined) {
            ...
            .catch(error => {
                ...
                // Mostrar un botón de "play" para que el usuario inicie manualmente
    ...
    function initApp() {
        ...
        audio.muted = true; // Iniciar con mute para evitar problemas con políticas de autoplay
        ...
        function updateVolume(value) {
            ...
            // Si el audio está muteado y el volumen es mayor que 0, quitar el mute
